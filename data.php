<table id="data" class="table table-striped table-bordered" style="width: 100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
            <button style='font-size: 11px;' class='btn btn-success edit_data' id="<?php echo $id; ?>" name='simpan' title='Simpan Data'>
            <i class="fa fa-edit"></i></button>
            <button style='font-size: 11px;' class='btn btn-danger hapus_data' id="<?php echo $id; ?>" name='hapus' title='Hapus Data'>
